...
var resultView = new Vue({
  ...
  data: {
    ...
    NorthScene: [
      ...
      {background: 0, character: 0, speaker: "Billy", nextScene: 14, story: "I'm Billy Magic-"},
      {background: 0, character: 0, speaker: "Unknown Voice", nextScene: 15, story: "BILLY MAGIC"},
      {background: 0, character: 0, speaker: "Billy", nextScene: 16, story: "-an upperclassman here at Michigan! Let me introduce you to… Magic Bus!"},
      {background: 0, character: 0, speaker: "You", nextScene: 17, story: "(where did that loud voice come from? weird.)"},
      {background: 1, character: 0, speaker: "Billy", nextScene: 18, story: "This is the Central Campus Transit Center, also known as CC Little. All the blue buses, which are the university buses that take you around campus, stop here. And, they're free!"},
      {background: 1, character: 0, speaker: "You", nextScene: 19, story: "Nice to meet you Billy. That's the bus system right? Which one should I take to get to north campus?"},
      {background: 1, character: 0, speaker: "Billy", nextScene: 20, story: "Well, you have a lot of options. I would recommend Bursley-Baits or Northwood, those are usually the fastest, you can always check the app Magic Bus to see which one is arriving soonest - definitely useful in these cold times! Anyways, I've got to head to a bus convention soon, but let's meet up again later so I can show you around a bit more! *wink*"},
      {background: 1, character: 0, speaker: "You", nextScene: 21, story: "Thanks a lot Billy, I'll see you later!"},
      {background: 2, character: 1, speaker: "Narrator", nextScene: 22, story: "You get on Bursley-Baits and find yourself a seat. After a rather uneventful ride, you find yourself on North Campus."},
      {background: 3, character: 1, speaker: "You", nextScene: 23, story: "(hmm, I have a lot of time before my first class, and I'm kind of hungry, maybe I should get some food)"},
      {background: 4, character: 1, speaker: "Narrator", nextScene: 24, story: "In the corner of your eye, you spot a restaurant called Panda Express. "},
      {background: 4, character: 1, speaker: "You", nextScene: 25, story: "(wow, that looks good! I think I'll eat there)"},
      {background: 5, character: 1, speaker: "Narrator", nextScene: 26, story: "You order a bowl of fried rice and orange chicken and make your way to the checkout."},
      {background: 6, character: 1, speaker: "Panda Express Employee", nextScene: 27, story: "...Drink? Donation?"},
      {background: 6, character: 1, speaker: "You", button: [{text: "Yes", goto: 28}, {text: "No", goto: 20}]},
      {background: 6, character: 1, speaker: "You", nextScene: 29, story: "Sure, round it up please."},
      {background: 6, character: 1, speaker: "You", nextScene: 30, story: "No thank you."},
      {background: 7, character: 1, speaker: "You", nextScene: 31, story: "This look so great ... can't wait to dig in!"},
      {background: 8, character: 1, speaker: "You", nextScene: 32, story: "Wow, what a great meal .. I'm so full, let me pack the rest to go. "},
      {background: 9, character: 1, speaker: "Narrator", nextScene: 33, story: "You look out of the window to see a snowball fight going on."},
      {background: 9, character: 1, speaker: "You", nextScene: 34, story: "I still have so much time to kill. Seems like there's a snowball fight going on outside.. Maybe I'll join! "},
      {background: 10, character: 1, speaker: "Narrator", nextScene: 35, story: "You walk over to the people snowball fighting in front of the BBB"},
      {background: 10, character: 2, speaker: "Snowball Fight Player", nextScene: 36, story: "Hey, do you want to join us?"},
      {background: 10, character: 2, speaker: "You", nextScene: 37, story: "Of course!", },
      {background: 10, character: 3, speaker: "Snowball Fight Player", nextScene: 38, story: "Be careful what you wish for!", },
      {background: 11, character: 1, speaker: "You", nextScene: 39, story: "Whoa!!", },
      {background: 10, character: 2, speaker: "Snowball Fight Player", nextScene: 40, story: "Hahhaha, my name is Carton. I'm actually getting pretty cold, do you want to go into the BBB and play some pingpong with me?", },
      {background: 10, character: 2, speaker: "You", nextScene: 41, story: "Yeah sure", },
      {background: 12, character: 1, speaker: "You", nextScene: 42, story: "Shoot! I forgot about class!! Sorry Calton, I gotta go ", },
      {background: 13, character: 1, speaker: "You", nextScene: 43, story: "Ah, finally GG Brown - can't wait to take my first Umich EECS course", },
    ],
