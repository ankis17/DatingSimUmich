...
var resultView = new Vue({
  ...
  data: {
    ...
    character_img: ["images/billy_magic.png", "images/noCharacter.png", "images/snowballCharacter.png", "images/throwingCharacter.png"],
    scene: [
      ...
      {background: 0, character: 1, speaker: "Narrator", nextScene: 2, story: "Out of the corner of your eye, you see a person approach you. Who could it be?"},
      {background: 0, character: 0, speaker: "???", nextScene: 3, story: "Hey! How's it going? Are you a new student here? I saw you walking around and you looked a bit confused as to where to go."},
      {background: 0, character: 0, speaker: "You", nextScene: 4, story: "(wow, he looks like he works out a lot) Yeah, this is my first day on campus, so I'm a bit lost. I can't figure out how to get to the STAMPS building. What's your name?"},
      {background: 0, character: 0, speaker: "Billy", nextScene: 5, story: "I'm Billy Magic-"},
      {background: 0, character: 0, speaker: "Unknown Voice", nextScene: 6, story: "BILLY MAGIC"},
      {background: 0, character: 0, speaker: "Billy", nextScene: 7, story: "-an upperclassman here at Michigan! Let me introduce you to… Magic Bus!"},
      {background: 0, character: 0, speaker: "You", nextScene: 8, story: "(where did that loud voice come from? weird.)"},
      {background: 1, character: 0, speaker: "Billy", nextScene: 9, story: "This is the Central Campus Transit Center, also known as CC Little. All the blue buses, which are the university buses that take you around campus, stop here. And, they're free!"},
      {background: 1, character: 0, speaker: "You", nextScene: 10, story: "Nice to meet you Billy. That's the bus system right? Which one should I take to get to north campus?"},
      {background: 1, character: 0, speaker: "Billy", nextScene: 11, story: "Well, you have a lot of options. I would recommend Bursley-Baits or Northwood, those are usually the fastest, you can always check the app Magic Bus to see which one is arriving soonest - definitely useful in these cold times! Anyways, I've got to head to a bus convention soon, but let's meet up again later so I can show you around a bit more! *wink*"},
      {background: 1, character: 0, speaker: "You", nextScene: 12, story: "Thanks a lot Billy, I'll see you later!"},
      {background: 2, character: 1, speaker: "Narrator", nextScene: 13, story: "You get on Bursley-Baits and find yourself a seat. After a rather uneventful ride, you find yourself on North Campus."},
      {background: 3, character: 1, speaker: "You", nextScene: 14, story: "(hmm, I have a lot of time before my first class, and I'm kind of hungry, maybe I should get some food)"},
      {background: 4, character: 1, speaker: "Narrator", nextScene: 15, story: "In the corner of your eye, you spot a restaurant called Panda Express. "},
      {background: 4, character: 1, speaker: "You", nextScene: 16, story: "(wow, that looks good! I think I'll eat there)"},
      {background: 5, character: 1, speaker: "Narrator", nextScene: 17, story: "You order a bowl of fried rice and orange chicken and make your way to the checkout."},
      {background: 6, character: 1, speaker: "Panda Express Employee", nextScene: 18, story: "...Drink? Donation?"},
      {background: 6, character: 1, speaker: "You", button: [{text: "Yes", goto: 19}, {text: "No", goto: 20}]},
      ...
      {background: 13, character: 1, speaker: "You", nextScene: 33, story: "Ah, finally GG Brown - can't wait to take my first Umich EECS course", },
    ],
